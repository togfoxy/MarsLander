...
local shipImage = {}
shipImage[1] = Assets.getImageSet("ship_landing1")
shipImage[2] = Assets.getImageSet("ship_landing2")
shipImage[3] = Assets.getImageSet("ship_landing3")
shipImage[4] = Assets.getImageSet("ship_landing4")
shipImage[5] = Assets.getImageSet("ship_landing5")
